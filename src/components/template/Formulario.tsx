...
export default function Formulario(props: FormularioProps) {
  ...
  const [preco, setPreco] = useState(props.ticket?.preco ?? 0)
  ...
  return (
    <div>
      <div className="">
        ...
        <Entrada texto="Preco" valor={preco} valorMudou={setPreco} className="m-2" />
        ...
        <div className="flex justify-end mt-7">
          ...
          text-white px-4 py-2 rounded-md mr-2"
            onClick={() => props.ticketMudou?.(new Ticket(randomCode, categoria, +preco,
             +validade, +auth, status, id))} >
            {id ? 'Alterar' : 'Salvar'}
          </BotaoAdd>
