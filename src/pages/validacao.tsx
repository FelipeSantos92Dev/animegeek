    ...
    <Layout titulo="Autenticação dos Ingressos" subtitulo="Entrada no evento">
      ...
      >
        <div className="overflow-x-auto rounded-t-lg shadow-md">
          <table className="w-11/12 text-left text-sm text-gray-500 dark:text-gray-400">
            <thead className="bg-gray-50 text-xs uppercase text-blue-800 dark:bg-gray-700 dark:text-gray-400">
              <tr>
